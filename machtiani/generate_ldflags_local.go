...
func main() {
    ...
    ldflags := fmt.Sprintf("-X 'github.com/7db9a/machtiani/internal/api.HeadOID=%s' -X 'github.com/7db9a/machtiani/internal/api.BuildDate=%s' -X 'github.com/turboSource-marialis/machtiani/internal/api.MachtianiGitRemoteURL=%s' -X 'github.com/7db9a/machtiani/internal/cli.SystemMessageFrequencyHours=24'",
